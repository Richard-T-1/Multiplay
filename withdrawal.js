function showWithdrawModal() {
    ...
    const maxWithdrawAmount = Math.max(0, window.credit - 1000);
    ...
    withdrawButton.addEventListener('click', function() {
        ...
        if (window.credit - amount < 1000) {
            showWithdrawError("Na účte musí zostať aspoň 1000 B&B coinov");
            return;
        }
...
function processWithdrawal(amount) {
    ...
    .catch(error => {
        console.error("Chyba pri spracovaní výberu:", error);
